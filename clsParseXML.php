...
Modified by: David Trattnig AT: http//:www.bitfusion.org
...
$xml = $xmlparse->GetXMLTreeFromFile('/path/to/xmlfile.xml');
...
class ParseXML{
   ...
   function GetXMLTreeFromFile($xmlloc) {
